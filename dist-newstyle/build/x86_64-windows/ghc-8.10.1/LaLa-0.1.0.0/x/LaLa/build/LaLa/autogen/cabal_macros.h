...
/* package LaLa-0.1.0.0 */
#ifndef VERSION_LaLa
#define VERSION_LaLa "0.1.0.0"
#endif /* VERSION_LaLa */
#ifndef MIN_VERSION_LaLa
#define MIN_VERSION_LaLa(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_LaLa */
...
#define CURRENT_COMPONENT_ID "LaLa-0.1.0.0-inplace-LaLa"
